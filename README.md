...
Version 0.1.5-debug captures the active cell drag table before the vanilla world context menu clears it, then uses that captured drag state for corpse-to-trash detection.
